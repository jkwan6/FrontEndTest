...
{   // Common Rule for the methods in the Controller ==> api/Cities
    ...
    public class CitiesController : ControllerBase
    {
        ...
        public CitiesController(ApplicationDbContext context, ICityService service)  // Constructor
        {
        ...
        {
            Task<ActionResult<ApiResult<CityDTO>>> result = _service.GetCitiesAsync(pageIndex, pageSize);    // Calls the Service Layer
            return Ok(await result);                                                                        // Returns Value
        }
        ...
        {
            var city = _service.GetCityAsync(id);     // Calls the Service Layer
            if (city is null) { return NotFound(); }        // Check if City is Null
            return Ok(await city);                                // Returns City if not Null
        }
